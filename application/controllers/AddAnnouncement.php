<?
class AddAnnouncement extends CI_Controller
{
    ...
    public function page($offset=0){
        $config['base_url'] = base_url('AddAnnouncement/page');
        ...
        $slideBarList["AddAnnouncement"]['Active'] = "active";

        $content = "AddAnnouncementView";
